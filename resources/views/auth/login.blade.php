...
<div class="max-w-md mx-auto bg-white p-8 shadow-lg rounded-lg">
    ...
    <div class="text-center mt-6 space-y-3">
        ...
        <div class="flex justify-center gap-4">
            <a href="{{ route('register.aluno.form') }}" class="text-blue-500 hover:text-blue-600 font-medium hover:underline transition">
                Sou Aluno
            </a>
            <span class="text-gray-400">|</span>
            <a href="{{ route('register.professor.form') }}" class="text-green-500 hover:text-green-600 font-medium hover:underline transition">
                Sou Professor
            </a>
        </div>
    </div>
